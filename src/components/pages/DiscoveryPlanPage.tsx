...
const sessions: Session[] = [
  {
    ...
    activities: [
      { time: '0:00-0:15', activity: 'Welcome, introductions, agenda walkthrough', type: 'prep', facilitator: 'PM', notes: 'Set the tone, confirm attendees' },
      { time: '0:15-0:45', activity: 'Revenue targets, growth trajectory, commercial vision', type: 'workshop', facilitator: 'SA', notes: 'Capture current revenue baseline and ambition' },
      { time: '0:45-1:15', activity: 'Key KPIs: conversion rate, AOV, retention targets', type: 'workshop', facilitator: 'SA', notes: 'Document current vs target metrics' },
      { time: '1:15-1:30', activity: 'Break', type: 'break', facilitator: '', notes: '' },
      { time: '1:30-2:00', activity: 'Customer acquisition vs retention strategy discussion', type: 'workshop', facilitator: 'SA', notes: 'Where is investment focused? Ratio?' },
      { time: '2:00-2:30', activity: 'Demo key user journeys: discovery, purchase, repeat, wholesale', type: 'workshop', facilitator: 'SA / Client', notes: 'Client walks through current journeys; KPS notes pain points' },
      { time: '2:30-2:45', activity: 'Checkout performance: what % of revenue is impacted today?', type: 'decision', facilitator: 'SA', notes: 'Quantify the checkout problem' },
      { time: '2:45-3:00', activity: 'Agree primary success metrics and priority journeys for MVP', type: 'decision', facilitator: 'SA / PM', notes: 'Formal decision capture' },
    ],
  ...
  },
  {
    ...
    activities: [
      { time: '0:00-0:15', activity: 'Recap Session 1 decisions; set agenda', type: 'prep', facilitator: 'PM', notes: '' },
      { time: '0:15-0:50', activity: 'Product structure deep-dive: editions, condition, variants', type: 'workshop', facilitator: 'SA', notes: 'Explore whether variants or separate products suit the catalogue' },
      { time: '0:50-1:15', activity: 'Author and series relationships; metadata strategy (genre, tags)', type: 'workshop', facilitator: 'SA', notes: 'How are relationships modelled today?' },
      { time: '1:15-1:30', activity: 'Break', type: 'break', facilitator: '', notes: '' },
      { time: '1:30-2:00', activity: 'Product data source and dataset size assessment', type: 'workshop', facilitator: 'SA', notes: 'Understand volume: how many SKUs, how often updated?' },
      { time: '2:00-2:30', activity: 'Search functionality: native vs external (e.g. Algolia)', type: 'workshop', facilitator: 'SA', notes: 'Evaluate trade-offs given dataset size' },
      { time: '2:30-2:50', activity: 'Filtering, navigation structure, ranking and merchandising logic', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '2:50-3:10', activity: 'Decision: product model structure (variants vs separate products)', type: 'decision', facilitator: 'SA', notes: '' },
      { time: '3:10-3:30', activity: 'Decision: search approach and ranking/merchandising strategy', type: 'decision', facilitator: 'SA', notes: '' },
    ],
  ...
  },
  {
    ...
    activities: [
      { time: '0:00-0:10', activity: 'Recap and agenda', type: 'prep', facilitator: 'PM', notes: '' },
      { time: '0:10-0:40', activity: 'Promotion types: bundles, series-based, cohort-based', type: 'workshop', facilitator: 'SA', notes: 'Map current promotions and frequency' },
      { time: '0:40-1:05', activity: 'Discount rules, stacking behaviour, time-based campaigns', type: 'workshop', facilitator: 'SA', notes: 'Identify complexity ceiling for the platform' },
      { time: '1:05-1:20', activity: 'Break', type: 'break', facilitator: '', notes: '' },
      { time: '1:20-1:45', activity: 'Email-triggered discounts and CRM integration', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '1:45-2:05', activity: 'Loyalty programme: current state and platform options', type: 'workshop', facilitator: 'SA', notes: 'Evaluate apps vs custom build' },
      { time: '2:05-2:20', activity: 'Wholesale vs D2C pricing differences', type: 'workshop', facilitator: 'SA', notes: 'Are these separate storefronts or segments?' },
      { time: '2:20-2:30', activity: 'Decisions: MVP promotion types, complexity limits, native vs app', type: 'decision', facilitator: 'SA / PM', notes: '' },
    ],
  ...
  },
  {
    ...
    activities: [
      { time: '0:00-0:10', activity: 'Recap and agenda', type: 'prep', facilitator: 'PM', notes: '' },
      { time: '0:10-0:35', activity: 'Segmentation strategy: cohorts, behavioural triggers', type: 'workshop', facilitator: 'SA', notes: 'What data exists today?' },
      { time: '0:35-1:00', activity: 'Personalised homepage and content: ambition vs reality', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '1:00-1:15', activity: 'Break', type: 'break', facilitator: '', notes: '' },
      { time: '1:15-1:40', activity: 'Product recommendations: by author, series, genre, behaviour', type: 'workshop', facilitator: 'SA', notes: 'Native recs vs third-party (e.g. Nosto, Rebuy)' },
      { time: '1:40-2:00', activity: 'Role of AI chatbot; CRM tool integration', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '2:00-2:15', activity: 'Decision: personalisation ownership (tools vs custom)', type: 'decision', facilitator: 'SA', notes: '' },
      { time: '2:15-2:30', activity: 'Decision: MVP vs future-state scope; data sources for segmentation', type: 'decision', facilitator: 'SA / PM', notes: '' },
    ],
  ...
  },
  {
    ...
    activities: [
      { time: '0:00-0:10', activity: 'Recap and agenda', type: 'prep', facilitator: 'PM', notes: '' },
      { time: '0:10-0:35', activity: 'Page creation workflows: current process and pain points', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '0:35-1:00', activity: 'Drag-and-drop, WYSIWYG requirements; campaign scheduling', type: 'workshop', facilitator: 'SA', notes: 'Online Store Editor vs headless CMS' },
      { time: '1:00-1:15', activity: 'Break', type: 'break', facilitator: '', notes: '' },
      { time: '1:15-1:40', activity: 'Blog/editorial strategy and content types', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '1:40-2:05', activity: 'A/B testing and experimentation: tooling evaluation', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '2:05-2:20', activity: 'Decision: CMS approach (native vs headless)', type: 'decision', facilitator: 'SA', notes: '' },
      { time: '2:20-2:30', activity: 'Decision: marketing autonomy vs governance; experimentation tooling', type: 'decision', facilitator: 'SA / PM', notes: '' },
    ],
  ...
  },
  {
    ...
    activities: [
      { time: '0:00-0:10', activity: 'Recap and agenda', type: 'prep', facilitator: 'PM', notes: '' },
      { time: '0:10-0:45', activity: 'Full ecosystem mapping: platform + all third-party systems', type: 'workshop', facilitator: 'SA', notes: 'Whiteboard/Miro exercise: map every system' },
      { time: '0:45-1:15', activity: 'Integration patterns per system: API, event-driven, middleware', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '1:15-1:30', activity: 'Break', type: 'break', facilitator: '', notes: '' },
      { time: '1:30-2:00', activity: 'Real-time vs batch decisions per integration', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '2:00-2:30', activity: 'Ownership of business logic: platform vs external systems', type: 'workshop', facilitator: 'SA', notes: 'Where does pricing logic live? Promotions? Inventory?' },
      { time: '2:30-2:50', activity: 'Data flows between systems; performance impact of scripts/apps', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '2:50-3:10', activity: 'Decision: system ownership per capability', type: 'decision', facilitator: 'SA', notes: '' },
      { time: '3:10-3:30', activity: 'Decision: integration approach per platform; acceptable app reliance', type: 'decision', facilitator: 'SA / PM', notes: '' },
    ],
  ...
  },
  {
    ...
    activities: [
      { time: '0:00-0:10', activity: 'Recap and agenda', type: 'prep', facilitator: 'PM', notes: '' },
      { time: '0:10-0:40', activity: 'Order lifecycle walkthrough: end-to-end', type: 'workshop', facilitator: 'SA', notes: 'Map the full order journey from basket to fulfilment' },
      { time: '0:40-1:10', activity: 'Inventory ownership and pricing: where does truth live?', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '1:10-1:25', activity: 'Break', type: 'break', facilitator: '', notes: '' },
      { time: '1:25-2:00', activity: 'ERP integration approach: current state and target', type: 'workshop', facilitator: 'SA', notes: 'Key risk area: ERP uncertainty' },
      { time: '2:00-2:30', activity: 'Data flows, analytics, and tracking strategy', type: 'workshop', facilitator: 'SA', notes: 'GA4, server-side tagging, data warehouse considerations' },
      { time: '2:30-2:50', activity: 'Integration patterns: real-time vs batch, middleware needs', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '2:50-3:10', activity: 'Decision: system ownership of orders, inventory, pricing', type: 'decision', facilitator: 'SA', notes: '' },
      { time: '3:10-3:30', activity: 'Decision: integration architecture; core vs app-based capabilities', type: 'decision', facilitator: 'SA / PM', notes: '' },
    ],
  ...
  },
  {
    ...
    activities: [
      { time: '0:00-0:10', activity: 'Recap and agenda', type: 'prep', facilitator: 'PM', notes: '' },
      { time: '0:10-0:40', activity: 'Checkout experience: express checkout, guest vs logged-in, mobile', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '0:40-1:10', activity: 'Payment flows: authorise vs capture, refunds, edge cases', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '1:10-1:25', activity: 'Break', type: 'break', facilitator: '', notes: '' },
      { time: '1:25-1:55', activity: 'Complex scenarios: split orders, pre-orders, mixed baskets', type: 'workshop', facilitator: 'SA', notes: 'Align with fulfilment and ERP approach from Session 7' },
      { time: '1:55-2:20', activity: 'Fraud and risk management approach', type: 'workshop', facilitator: 'SA', notes: '' },
      { time: '2:20-2:40', activity: 'Integration impact on checkout performance', type: 'workshop', facilitator: 'SA', notes: 'Script audit, third-party load times' },
      { time: '2:40-3:00', activity: 'Decisions: capture strategy, complex basket handling, checkout priorities, fraud approach', type: 'decision', facilitator: 'SA / PM', notes: '' },
    ],
  ...
  },
  {
    ...
    activities: [
      { time: '0:00-0:15', activity: 'Full discovery recap: key decisions and open items', type: 'prep', facilitator: 'PM', notes: '' },
      { time: '0:15-0:45', activity: 'Roles and responsibilities: marketing vs development ownership', type: 'workshop', facilitator: 'PM / SA', notes: '' },
      { time: '0:45-1:15', activity: 'Release and deployment process; ways of working', type: 'workshop', facilitator: 'PM', notes: '' },
      { time: '1:15-1:30', activity: 'Break', type: 'break', facilitator: '', notes: '' },
      { time: '1:30-2:00', activity: 'MVP vs Phase 2 scope: walk through feature list', type: 'decision', facilitator: 'SA / PM', notes: 'Critical session: draw the line on MVP' },
      { time: '2:00-2:20', activity: 'Key risks and mitigations review', type: 'workshop', facilitator: 'PM', notes: '' },
      { time: '2:20-2:40', activity: 'Decision: final MVP scope, phased roadmap, governance model', type: 'decision', facilitator: 'SA / PM', notes: '' },
      { time: '2:40-3:00', activity: 'Playback of all discovery findings to senior stakeholders', type: 'output', facilitator: 'SA / PM', notes: 'Formal presentation and sign-off' },
    ],
                    ...
                    <div style={{ padding: '20px 24px' }}>
                      ...
                      <div style={{ overflowX: 'auto' }}>
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
                          <thead>
                            <tr>
                              {['Time', 'Activity', 'Type', 'Lead', 'Notes'].map(h => (
                                <th key={h} style={{
                          ...
                          <tbody>
                            {session.activities.map((a, j) => (
                              <tr key={j} style={{
                                ...
                                <td style={{ padding: '7px 10px', borderBottom: '1px solid rgba(255,255,255,0.04)', whiteSpace: 'nowrap', color: 'var(--grey-light)', fontSize: 12 }}>{a.time}</td>
