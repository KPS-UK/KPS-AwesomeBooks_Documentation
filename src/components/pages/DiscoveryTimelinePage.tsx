...
const sessions: Session[] = [
  {
    ...
    stakeholders: ['Mubin Ahmed - General Director', 'Mikey Warner - Group Technology Director', 'Mark Booth - UX/UI Lead', 'Martin Harvey - Senior Account Manager (KPS)'],
  ...
  },
  {
    ...
    stakeholders: ['Mubin Ahmed - General Director', 'Mikey Warner - Group Technology Director', 'Mark Booth - UX/UI Lead', 'Anna Beveridge - Senior Marketing Executive (AwesomeBooks)'],
